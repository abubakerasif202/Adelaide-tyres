...
export const metadata: Metadata = {
  ...
  description: `No minimum order. ${formatCurrency(order.delivery.feeAud)} Adelaide-wide delivery on wholesale tyre orders under ${order.delivery.freeQualifyingTyres} tyres, free from ${order.delivery.freeQualifyingTyres} tyres up. Warehouse pickup available at ${business.address.oneLine}.`,
